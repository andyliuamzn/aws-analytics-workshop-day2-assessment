...
1. Download the [Learn2Hire_v1.yml](https://github.com/andylearning0706/aws-analytics-workshop-assessment/blob/main/Learn2Hire_v1.yml) and upload it into cloudformation to create the required network services.
